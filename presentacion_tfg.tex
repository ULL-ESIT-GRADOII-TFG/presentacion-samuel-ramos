...
\begin{frame}[allowframebreaks]
  ...
  \begin{itemize}
    \item This tool pretends to be a complement to platforms like Moodle offering the possibility of specify programming questions.
    \item Provides an innovation solution for the storage of exams data: {\bfseries Google Drive}.
