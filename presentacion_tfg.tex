    ...
    \bigskip
      ...
      \begin{columns}
        ...
        \begin{column}{5.5cm}
          \hspace*{0.8cm}
          \begin{center}
            \includegraphics[width=0.4\textwidth]{img/terminal_icon.eps} \\
          \end{center}
          \scriptsize{\textit{[\textasciitilde]\$ ruql example.rb Html5 \textgreater \,output.html}}
        \end{column}
        % Fourth column
        \begin{column}{0.5cm}
          $\rightarrow$
  ...
  \begin{columns}
    ...
    \begin{column}{4cm}
      ...
      \begin{center}
        ...
        \scriptsize{\textit{[\textasciitilde]\$ ruql example.rb HtmlForm \textgreater \,output.html}}
      \end{center}
    \end{column}
    % Fourth column
    \begin{column}{0.5cm}
  ...
  \begin{itemize}
    ...
    \begin{columns}
      ...
      \begin{column}{5cm}
        \hspace*{0.8cm}
        \begin{center}
          \includegraphics[width=0.5\textwidth]{img/terminal_icon.eps} \\
          \textit{[\textasciitilde]\$ ruql example.rb Sinatra}
        \end{center}
      \end{column}
      % Fourth column
      \begin{column}{0.5cm}
